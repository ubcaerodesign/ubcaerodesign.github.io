  ...
  return (
    <div className="group py-8 border-b border-white/10 flex flex-col md:flex-row md:items-center gap-2 md:gap-12">
      <div className="md:w-1/3 shrink-0">
        <span className="font-titillium font-semibold text-lg text-white group-hover:text-aero-light-blue transition-colors tracking-wide">
          {label}
        </span>
      </div>
    ...
    <div className="min-h-screen bg-[#06121f]">
        ...
        <MarginWrapper className="relative z-10">
          <div className="max-w-4xl">
            ...
            <Reveal direction="up" delay={0.2}>
              <h1 className="font-titillium font-semibold text-5xl md:text-7xl text-white leading-tight mb-8 text-glow">
                Contact Us
              </h1>
            </Reveal>
        ...
        <MarginWrapper>
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
            ...
            <div className="lg:w-3/5">
              <Reveal>
                <div className="mb-12">
                  <p className="font-titillium font-semibold text-aero-yellow tracking-[0.2em] uppercase text-sm mb-4">Departments</p>
                  <h2 className="font-titillium font-semibold text-4xl text-white">REACH OUT</h2>
                </div>
              </Reveal>
            ...
            <div className="lg:w-2/5">
              <Reveal delay={0.15}>
                <div className="mb-12">
                  <p className="font-titillium font-semibold text-aero-yellow tracking-[0.2em] uppercase text-sm mb-4">Location</p>
                  <h3 className="font-titillium font-semibold text-2xl text-white mb-6 tracking-wide">MAILING ADDRESS</h3>
              ...
              <Reveal delay={0.25}>
                <div>
                  <p className="font-titillium font-semibold text-aero-yellow tracking-[0.2em] uppercase text-sm mb-6">Follow Us</p>
      ...
      <section className="relative min-h-[40vh] flex items-center justify-center overflow-hidden py-24">
        ...
        <div className="relative z-10 text-center px-6">
          <Reveal direction="up">
            <h2 className="font-titillium font-semibold text-4xl md:text-6xl text-white mb-8 text-glow">WE'D LOVE TO HEAR FROM YOU</h2>
