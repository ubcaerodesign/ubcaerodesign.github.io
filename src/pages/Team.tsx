  ...
  return (
    <div className="min-h-screen bg-[#06121f]">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-end overflow-hidden pb-16">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          <Reveal direction="up" delay={0.1}>
            <h1 className="font-poppins font-semibold text-5xl md:text-6xl lg:text-7xl text-white leading-none mb-5">
              OUR TEAM
            </h1>
          </Reveal>
          <Reveal direction="up" delay={0.2}>
            <p className="font-poppins font-semibold text-white/60 tracking-[0.3em] uppercase text-sm mb-8">
              Engineering Tomorrow's Aircraft Through Collaboration
            </p>
          </Reveal>
          <Reveal direction="up" delay={0.3}>
            <p className="font-urbanist text-white/55 text-lg leading-relaxed max-w-2xl mx-auto">
        ...
        <MarginWrapper>
          <Reveal className="mb-16">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
              ...
              <p className="font-urbanist text-white/40 text-sm max-w-xs leading-relaxed">
          ...
          <Reveal delay={0.1}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/5 rounded-2xl overflow-hidden mb-16">
              <div className="bg-[#06121f] p-10 group hover:bg-aero-dark-blue transition-colors duration-300">
                <div className="font-poppins font-semibold text-7xl text-white/10 mb-4 group-hover:text-white/20 transition-colors">3</div>
                <h3 className="font-poppins font-semibold text-2xl text-white mb-2">Divisions</h3>
                <p className="font-urbanist text-sm text-white/45 leading-relaxed">Advanced, Regular, and Micro — each tackling distinct mission profiles.</p>
              </div>

              <div className="bg-[#06121f] p-10 group hover:bg-aero-dark-blue transition-colors duration-300 border-l border-white/5">
                <div className="font-poppins font-semibold text-7xl text-aero-light-blue/20 mb-4 group-hover:text-aero-light-blue/40 transition-colors">7</div>
                <h3 className="font-poppins font-semibold text-2xl text-white mb-2">Technical Subteams</h3>
                <p className="font-urbanist text-sm text-white/45 leading-relaxed mb-6">Aerodynamics, Structures, Propulsion, Avionics, Software, Manufacturing, and Systems.</p>
                <Button
              ...
              <div className="bg-[#06121f] p-10 group hover:bg-aero-dark-blue transition-colors duration-300 border-l border-white/5">
                <div className="font-poppins font-semibold text-7xl text-aero-yellow/20 mb-4 group-hover:text-aero-yellow/40 transition-colors">7</div>
                <h3 className="font-poppins font-semibold text-2xl text-white mb-2">Admin Subteams</h3>
                <p className="font-urbanist text-sm text-white/45 leading-relaxed mb-6">Business, Marketing, Finance, Recruitment, Sponsorship, Events, and Media.</p>
                <Button
      ...
      <section className="py-14 border-y border-white/5 overflow-hidden">
        <p className="font-poppins font-semibold text-white/40 tracking-[0.25em] uppercase text-xs mb-8 text-center">
            ...
            {[...MEMBERS, ...MEMBERS, ...MEMBERS].map((member, i) => (
              <div key={i} className="relative group shrink-0 w-44 h-44 rounded-xl overflow-hidden">
                ...
                <div className="absolute inset-0 bg-aero-navy/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center p-4">
                  <p className="font-poppins font-semibold text-white text-center text-base leading-tight">{member.name}</p>
                  <p className="font-urbanist text-aero-yellow text-xs tracking-widest uppercase mt-2 text-center">{member.role}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <MarginWrapper>
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
            <Reveal direction="left" className="lg:w-1/2">
              ...
              <h2 className="font-poppins font-semibold text-4xl md:text-5xl text-white leading-tight mb-6">
                YOUR LAUNCHPAD
              </h2>
              <p className="font-urbanist text-white/55 text-lg leading-relaxed mb-6">
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden py-24">
        ...
        <div className="relative z-10 text-center px-6">
          <Reveal direction="up">
            <p className="font-poppins font-semibold text-aero-yellow tracking-[0.2em] uppercase text-sm mb-6 flex items-center justify-center gap-4">
              <span className="w-8 h-[1px] bg-aero-yellow" /> Open Recruitment
              <span className="w-8 h-[1px] bg-aero-yellow" />
            </p>
            <h2 className="font-poppins font-semibold text-5xl md:text-7xl text-white mb-4 text-glow">READY TO APPLY?</h2>
            <p className="font-urbanist text-white/50 text-lg mb-8">Next recruitment cycle begins August 2026.</p>
